        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Premier web development agency in Trinidad and Tobago, crafting extraordinary digital experiences since 2025.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">
                <a href="tel:+18684921566" className="hover:text-[#FF8A00] transition-colors duration-300">
                  Call: +1 (868) 492-1566
                </a>
              </li>
              <li className="text-gray-400">
              ...
              <li className="text-gray-400">Founded August 2025</li>
            </ul>

            {/* Social Media */}
            <div className="mt-6">
              <h4 className="text-md font-semibold mb-3 text-[#FF8A00]">Follow Us</h4>
              <div className="flex space-x-4">
                <a
                  href="https://www.instagram.com/nexuswebtt/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-[#FF8A00] transition-colors duration-300"
