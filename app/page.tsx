...
export default function Home() {
  ...
  return (
    ...
    <main ref={containerRef} className="select-none touch-pan-y overscroll-none">
      {/* Hero Section */}
        <section ref={heroRef} className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#0a0a1a] via-[#1a1a2e] to-[#16213e]">
          ...
          <div className="container mx-auto px-4 relative z-10 pt-32 pb-20">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
              ...
              >
                ...
                >
                  <span className="text-[#FF8A00] font-semibold">✨ Web Development & Design Excellence</span>
                </motion.div>
                ...
                >
                  Crafting extraordinary digital experiences that captivate, convert, and scale your business to new heights.
                </motion.p>
                ...
                >
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#FF8A00] mb-2">100+</div>
                    <p className="text-gray-400 text-sm">Projects Delivered</p>
              </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#FF8A00] mb-2">5+</div>
                    <p className="text-gray-400 text-sm">Years Experience</p>
                  </div>
                  <div className="text-center col-span-2 md:col-span-1">
                    <div className="text-3xl font-bold text-[#FF8A00] mb-2">24/7</div>
                  ...
                  >
                    <div className="relative bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-4 border border-white/20 shadow-2xl overflow-hidden">
                      ...
                      <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 relative">
                        <Image
                          src="https://picsum.photos/800/600?random=20&business"
                          alt="Modern Business Dashboard - Analytics and Growth"
                          width={800}
                          height={600}
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-semibold text-gray-800">Revenue +24%</span>
                          </div>
                        </motion.div>
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-semibold text-gray-800">Users 1.2K</span>
                          </div>
                        </motion.div>
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-semibold text-gray-800">Conversion 12.5%</span>
                          </div>
                        </motion.div>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                {[
                  { number: "100+", label: "Projects Completed", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
                  { number: "50+", label: "Happy Clients", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-2.239" },
                  { number: "5+", label: "Years Experience", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
                  { number: "24/7", label: "Support Available", icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364" }
                ].map((stat, index) => (
                  <motion.div
                    key={index}
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal className="text-center mb-20">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                We&apos;re not just another web agency. We&apos;re your digital growth partners, specializing in the Caribbean market.
              </p>
            </ScrollReveal>
              ...
              {[
                {
                  ...
                  description: "Deep understanding of the local market, culture, and business landscape. We know what works in the Caribbean.",
                  icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z",
                  color: "from-blue-500 to-cyan-500"
                },
                {
                  title: "Proven Track Record",
                  description: "5+ years of experience with 100+ successful projects. From startups to established businesses, we deliver results.",
                  icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
                  color: "from-green-500 to-emerald-500"
                },
                {
                  title: "Modern Technology Stack",
                  description: "We use cutting-edge technologies like React, Next.js, and modern design principles to build future-proof websites.",
                  icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4",
                  color: "from-purple-500 to-pink-500"
                },
                {
                  title: "Mobile-First Approach",
                  description: "With 80% of Caribbean users browsing on mobile, we ensure your website looks perfect on every device.",
                  icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z",
                  color: "from-orange-500 to-red-500"
                },
                {
                  title: "SEO & Local Marketing",
                  description: "Dominate local search results and reach your target audience in Trinidad, Tobago, and the wider Caribbean.",
                  icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",
                  color: "from-indigo-500 to-purple-500"
                },
                {
                  title: "Ongoing Support",
                  description: "24/7 technical support, regular updates, and maintenance to keep your website secure and performing optimally.",
        ...
        <section className="py-32 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                From stunning websites to powerful digital marketing, we provide everything your Trinidad & Tobago business needs to succeed online.
              </p>
            </ScrollReveal>
              ...
              {[
                {
                  ...
                  description: "Custom websites and web applications built with modern technologies. Responsive, fast, and optimized for the Caribbean market.",
                  color: "from-blue-500 to-cyan-500",
                  delay: 0.2
                },
                {
                  ...
                  description: "Dominate local search results and reach your target audience in Trinidad, Tobago, and throughout the Caribbean region.",
                  color: "from-green-500 to-emerald-500",
                  delay: 0.4
                },
                {
                  ...
                  description: "Complete online store solutions with secure payments, inventory management, and mobile-optimized shopping experiences.",
                  color: "from-purple-500 to-pink-500",
                  delay: 0.6
                }
              ].map((feature, index) => (
          ...
          <div className="container mx-auto px-4 relative z-10">
            <ScrollReveal className="text-center mb-20">
              <motion.div
                ...
                className="inline-block px-6 py-3 rounded-full bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-200 mb-8"
              >
                <span className="text-[#FF8A00] font-semibold text-lg">💬 Client Stories</span>
              </motion.div>
              <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-8 leading-tight">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                See what our clients have to say about their transformative experience working with Nexus Web
              </p>
            </ScrollReveal>
              ...
              {[
                {
                  ...
                  quote: "Nexus Web delivered exceptional results that exceeded our expectations. Their expertise in modern web development and attention to detail transformed our online presence completely. The new website has significantly improved our user engagement and conversion rates.",
                  rating: 5,
                  delay: 0.2
                },
                {
                  ...
                  quote: "Working with Nexus Web was a game-changer for our business. Their modern approach to web development, innovative design solutions, and commitment to performance helped us achieve our digital goals faster than we imagined.",
                  rating: 5,
                  delay: 0.4
                }
                ...
                <ScrollReveal key={index} delay={testimonial.delay}>
                  ...
                  >
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-[#FF8A00]/5 to-[#FF4D00]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                    />
      ...
      {/* CTA Section */}
        ...
        <div className="container mx-auto px-4 relative z-10">
            <ScrollReveal className="max-w-5xl mx-auto text-center">
              ...
              >
                <span className="text-[#FF8A00] font-semibold text-lg">🚀 Start Building Today</span>
              </motion.div>
              ...
              >
                Join the hundreds of businesses that have already elevated their online presence with our expert web development services and cutting-edge design solutions.
              </motion.p>
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    whileHover={{ scale: 1.1 }}
                  >
                    <div className="text-4xl md:text-5xl font-bold text-[#FF8A00] mb-3">{stat.number}</div>
